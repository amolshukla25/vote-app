// Throwaway script: close voting (votingOpen -> false) in the live MongoDB config.
// Usage: node scratch/close-voting.js
const fs = require('fs');
...
async function main() {
  ...
  const res = await col.updateOne({ _id: 'app' }, { $set: { votingOpen: false } });
